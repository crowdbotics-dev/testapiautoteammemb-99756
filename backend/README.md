...
## Project Structure
    ...
    ├── testapiautoteammemb_99756  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_99756`
...
2. Clone this repo and `cd testapiautoteammemb_99756`
